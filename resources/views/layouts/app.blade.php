...
<head>
    ...
    <title>@yield('title', 'Koperasi Simpan Pinjam Guru')</title>
        ...
        <aside id="sidebar" class="d-print-none">
            ...
            <ul class="menu-list">
                @if(auth()->user()->role === 'admin')
                    ...
                    <li class="menu-item">
                        <a href="{{ route('admin.anggota.index') }}" class="menu-link {{ request()->routeIs('admin.anggota.*') ? 'active' : '' }}">
                            <i class="fa-solid fa-users"></i>
                            <span>Data Anggota</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('admin.simpanan.index') }}" class="menu-link {{ request()->routeIs('admin.simpanan.*') ? 'active' : '' }}">
                            <i class="fa-solid fa-wallet"></i>
                            <span>Kelola Simpanan</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('admin.pinjaman.index') }}" class="menu-link {{ request()->routeIs('admin.pinjaman.*') ? 'active' : '' }}">
                ...
                @else
                    <!-- Member Menu -->
                    <li class="menu-item">
                        <a href="{{ route('anggota.dashboard') }}" class="menu-link {{ request()->routeIs('anggota.dashboard') ? 'active' : '' }}">
                            <i class="fa-solid fa-house"></i>
                            <span>Dashboard Saya</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('anggota.simpanan') }}" class="menu-link {{ request()->routeIs('anggota.simpanan') ? 'active' : '' }}">
                            <i class="fa-solid fa-piggy-bank"></i>
                            <span>Simpanan Saya</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('anggota.pinjaman.index') }}" class="menu-link {{ request()->routeIs('anggota.pinjaman.index') ? 'active' : '' }}">
                            <i class="fa-solid fa-clock-rotate-left"></i>
                            <span>Pinjaman Saya</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('anggota.pinjaman.ajukan') }}" class="menu-link {{ request()->routeIs('anggota.pinjaman.ajukan') ? 'active' : '' }}">
                ...
                <li class="menu-item">
                    <a href="{{ route('profil') }}" class="menu-link {{ request()->routeIs('profil') ? 'active' : '' }}">
        ...
        <div id="main-content">
            ...
            <header id="top-navbar" class="d-print-none">
                ...
                <div class="nav-right ms-auto">
                    <!-- Role Switcher Badge -->
                    <a href="{{ route('switch-role') }}" class="role-switcher-badge text-decoration-none" title="Klik untuk beralih mode cepat">
                        @if(auth()->user()->role === 'admin')
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow mt-2" aria-labelledby="profileDropdown">
                            <li><a class="dropdown-item" href="{{ route('profil') }}"><i class="fa-solid fa-circle-user me-2 text-muted"></i>Profil Saya</a></li>
