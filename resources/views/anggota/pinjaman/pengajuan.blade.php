...
@section('title', 'Ajukan Pinjaman - Koperasi Guru')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('anggota.pinjaman.index') }}">Pinjaman Saya</a></li>
        ...
        <div class="col-12 col-md-8 col-lg-6">
            ...
            @if($hasActiveLoan)
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center bg-white">
                    ...
                    <a href="{{ route('anggota.pinjaman.index') }}" class="btn btn-light border px-4 py-2 small fw-medium"><i class="fa-solid fa-clock-rotate-left me-1"></i> Periksa Riwayat Pinjaman</a>
                </div>
            @else
                <!-- Form Page -->
                <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                    ...
                    <form action="{{ route('anggota.pinjaman.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            <a href="{{ route('anggota.pinjaman.index') }}" class="btn btn-light border">Batal</a>
