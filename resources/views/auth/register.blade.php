                    ...
                    <form action="{{ route('register.post') }}" method="POST">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Ani Rahmawati, S.Pd." required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="nip" class="form-label small fw-medium">NIP (Nomor Induk Pegawai)</label>
                                <input type="text" class="form-control" id="nip" name="nip" value="{{ old('nip') }}" placeholder="Contoh: 19870425..." required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="guru@sekolah.sch.id" required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="phone" class="form-label small fw-medium">Nomor HP / WhatsApp</label>
                                <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Contoh: 081234567..." required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="2" placeholder="Tulis alamat tinggal sekarang..." required>{{ old('address') }}</textarea>
                        </div>
                        ...
                        <div class="text-center small">
                            ...
                            <a href="{{ route('login') }}" class="text-navy fw-semibold ms-1">Masuk di sini</a>
                        </div>
                    </form>
                </div>
