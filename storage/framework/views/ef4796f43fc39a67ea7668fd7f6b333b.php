                    ...
                    <form action="<?php echo e(route('login.post')); ?>" method="POST" id="loginForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control bg-light border-start-0 py-2" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="nama@sekolah.sch.id" required autofocus>
                            </div>
                        </div>
                       ...
                       <div class="mb-4">
                        ...
                        <div class="text-center" style="font-size:13px;">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="text-navy fw-semibold ms-1">Daftar di sini</a>
                        </div>
                    </form>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Koperasi_SimpanPinjam\resources\views/auth/login.blade.php ENDPATH**/ ?>