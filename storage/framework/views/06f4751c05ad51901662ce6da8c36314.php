<?php $__env->startSection('title', 'Profil Saya - Koperasi Guru'); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 p-4 text-center bg-white">
                ...
                <span class="badge bg-secondary-subtle text-secondary px-3 py-1.5 rounded-pill mb-4"><?php echo e($user->nip ?? 'NIP: -'); ?></span>
                
                <div class="text-start border-top pt-3 small">
                    <div class="mb-2">
                        <span class="text-muted d-block">Hak Akses:</span>
                        <strong class="text-dark"><?php echo e(ucfirst($user->role)); ?></strong>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-0">
                        ...
                        <strong class="text-dark"><?php echo e($user->created_at->format('d F Y')); ?></strong>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form action="<?php echo e(route('profil.update')); ?>" method="POST">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" name="nip" value="<?php echo e(old('nip', $user->nip)); ?>" <?php echo e($user->role !== 'admin' ? 'readonly' : ''); ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="address" rows="2"><?php echo e(old('address', $user->address)); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Koperasi_SimpanPinjam\resources\views/profil.blade.php ENDPATH**/ ?>